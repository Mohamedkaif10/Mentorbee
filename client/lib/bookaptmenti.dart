...
import 'payment_page_menti.dart';

class BookAppointmentPageMenti extends StatefulWidget {
  final Map<String, dynamic> mentiDetails;
  final String sessionPrice;

   BookAppointmentPageMenti({required this.mentiDetails,  this.sessionPrice=''});

  @override
  _BookAppointmentPageState createState() => _BookAppointmentPageState();
}

class _BookAppointmentPageState extends State<BookAppointmentPageMenti> {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                'Buddy Name: ${widget.mentiDetails['name'] ?? 'Loading...'}',
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                        PaymentPageMenti(amount: sessionPrice),
                    ),
                  );
